...
class Converter:
    ...
    def __init__(self, tables='data/csgsql/tables.json', db='data/database'):
        self.tables = tables
        self.db = db
...
if __name__ == '__main__':
    ...
    parser.add_argument('--fsplit', default=os.path.join('data', 'csgsql', 'dev.json'))
