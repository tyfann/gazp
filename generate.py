...
def get_parser():
    ...
    parser.add_argument('--dataset', default='csgsql', choices=('spider', 'sparc', 'cosql', 'chase', 'csgsql'), help='dataset to use')
    ...
    parser.add_argument('--ftrain', default='data/csgsql/train.json', help='train json files')
    ...
    parser.add_argument('--fout', default='gen/csgsql_gen1.json', help='generated output  file')
